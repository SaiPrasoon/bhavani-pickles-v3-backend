...
const MONGO_URI =
  'mongodb://mongo:ljHjumYTBPkKknJaXpnhrJdqJcrXnUOu@mainline.proxy.rlwy.net:40546/test?authSource=admin';

// ── Existing category IDs in testing DB ──────────────────────────────────────
...
async function seed() {
  ...
  // Clear only products and variants (keep existing categories)
